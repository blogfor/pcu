...
<div id="content" class="container">
   ...
   <div class="checkout">
    ...
    <?php if (!$logged) { ?>
    <div id="payment-address" class="checkout-steps">
      <div class="checkout-heading steps-heading"><span><?php echo $text_checkout_account; ?></span></div>
      <div class="checkout-content"></div>
    </div>
    ...
    <?php } else { ?>
    <div id="payment-address" class="checkout-steps">
      <div class="checkout-heading steps-heading"><span><?php echo $text_checkout_payment_address; ?></span></div>
      <div class="checkout-content"></div>
    </div>
    <?php } ?>
    <?php if ($shipping_required) { ?>
    <div id="shipping-address" class="checkout-steps">
      <div class="checkout-heading steps-heading"><?php echo $text_checkout_shipping_address; ?></div>
      <div class="checkout-content"></div>
    </div>
    <div id="shipping-method" class="checkout-steps">
      <div class="checkout-heading steps-heading"><?php echo $text_checkout_shipping_method; ?></div>
      <div class="checkout-content"></div>
    </div>
    <?php } ?>
    <div id="payment-method" class="checkout-steps">
      <div class="checkout-heading steps-heading"><?php echo $text_checkout_payment_method; ?></div>
      <div class="checkout-content"></div>
    </div>
    <div id="confirm" class="checkout-steps">
      <div class="checkout-heading steps-heading"><?php echo $text_checkout_confirm; ?></div>
      <div class="checkout-content"></div>
    </div>
  </div>
