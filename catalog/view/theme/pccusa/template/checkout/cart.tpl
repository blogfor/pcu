...
<div class="success container">
    <?php echo $success; ?><img src="catalog/view/theme/default/image/close.png" alt="" class="close" />
</div>
<?php } ?>
...
<h1 class="big-title"><?php echo $heading_title; ?>      
  ...
  <div class="cart-module container row" style="margin-bottom:20px;">
    ...
    <div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
      <p><strong><?php echo $text_shipping_detail; ?></strong></p>
      ...
      <input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="action-button" />
    </div>
  </div>
  <?php } ?>
  <div class="cart-total">
    <table id="total">
      ...
      <tr>
        <td width="75%"></td>  
        <td  width="15%" class="right"><b><?php echo $total['title']; ?>:</b></td>
        <td   width="10%" class="right"><?php echo $total['text']; ?></td>
      </tr>	  
      <?php } ?>
    </table>
  </div>
  ...
  <div class="col-lg-11" style="text-align:right;"><a href="<?php echo $continue; ?>" class="action-button"><?php echo $button_shopping; ?></a></div>
  <div class="col-lg-1" style="text-align:right;"><a href="<?php echo $checkout; ?>" class="action-button"><?php echo $button_checkout; ?></a></div>  
