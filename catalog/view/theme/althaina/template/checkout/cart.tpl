...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="content">
    ...
    <table class="radio" style="padding-left: 20px;">
      ...
      <tr class="highlight">
        <td><?php if ($next == 'coupon') { ?>
          ...
          <?php } ?>
        <label for="use_coupon"><?php echo $text_use_coupon; ?></label></td>
      </tr>
      <?php } ?>
      ...
      <tr class="highlight">
        <td><?php if ($next == 'voucher') { ?>
          ...
          <?php } ?>
        <label for="use_voucher"><?php echo $text_use_voucher; ?></label></td>
      </tr>
      <?php } ?>
      ...
      <tr class="highlight">
        <td><?php if ($next == 'reward') { ?>
          ...
          <?php } ?>
        <label for="use_reward"><?php echo $text_use_reward; ?></label></td>
      </tr>
      <?php } ?>
      ...
      <tr class="highlight">
        <td><?php if ($next == 'shipping') { ?>
          ...
          <?php } ?>
        <label for="shipping_estimate"><?php echo $text_shipping_estimate; ?></label></td>
      </tr>
      <?php } ?>
    </table>
  </div>
