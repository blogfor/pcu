<?php echo $header; ?>
<div id="content" class="row"><!--new-div-->
<?php echo $column_left; ?>
<?php //echo $column_right; ?>

<div id="content1" class=" row col-lg-9 col-md-9 col-sm-9" ><?php echo $content_top; ?>
  ...
  <div class="product-info row">
    <?php if ($thumb || $images) { ?>
     <div class="col-lg-5 col-md-5 col-sm-5">
       <?php if ($thumb) { ?>       
      <div class="image">
          <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="colorbox1" rel="colorbox">*}
              <img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a>
      </div>      
      <?php } ?>
      <?php if ($images) { ?>
      <div class="image-additional" style="width:<?php echo  $this->config->get('config_image_thumb_width')+30 ?>px">
        <?php foreach ($images as $image) { ?>
        <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" class="colorbox1" rel="colorbox">
...
<div class=" col-lg-7 col-md-7 col-sm-7">
  <h1><span><?php echo $heading_title; ?></span></h1>
      ...
      <!-- add to cart-->      
       <div class="add-cart"><?php echo $text_qty; ?>
          <input type="text" name="quantity" class="w30" size="2" value="<?php echo $minimum; ?>" />
          <input type="hidden" name="product_id" size="2" value="<?php echo $product_id; ?>" />
          &nbsp;<a id="button-cart" class="button" title="Add to Cart"><?php echo $button_cart; ?></a>&nbsp;&nbsp;
        </div>       
     ...
     <!-- wishlist- compare -->
        <div class="wish-compare"><a class="info-wish" onclick="addToWishList('<?php echo $product_id; ?>');" title="<?php echo $button_wishlist; ?>"><i class="icon-wishlist"></i> <?php echo $button_wishlist; ?></a><br />
         <a class="info-compare" onclick="addToCompare('<?php echo $product_id; ?>');" title="<?php echo $button_compare; ?>"><i class="icon-compare"></i> <?php echo $button_compare; ?></a></div>
        <?php if ($minimum > 1) { ?>
      ...
      <div class="review">
        <div>
        <a  onclick="$('a[href=\'#tab-review\']').trigger('click');"><span class="write-review"></span><?php echo $text_write; ?></a>
        <br/><img src="catalog/view/theme/althaina/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />
    ...
    <table class="attribute">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="text-align:left !important; "><?php echo $attribute['text']; ?></td>
        </tr>
        <?php } ?>
      </tbody>
      <?php } ?>
